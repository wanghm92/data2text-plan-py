...
from onmt.Models import NMTModel, MeanEncoder, RNNEncoder, PointerRNNDecoder,\
                        StdRNNDecoder, InputFeedRNNDecoder, GraphEncoder
...
def make_base_model(model_opt, fields, gpu, checkpoint=None, stage1=True):
    """
    Args:
        model_opt: the option loaded from checkpoint or opt set for this new round of training/testing
    ...
    #! --- encoder ---
    assert model_opt.model_type == "text"
    #! make_embeddings
