...
DEC=2
OUTLAYER=gating
IDENTIFIER=$PREPATH\_dim-$DIM\_batch-$BAT\_layer-$DEC
# IDENTIFIER=$PREPATH\_$OUTLAYER\_selfattn_dim-$DIM\_batch-$BAT\_layer-$DEC
printf "IDENTIFIER = $IDENTIFIER"
OUTPUT=/mnt/cephfs2/nlp/hongmin.wang/table2text/data2text-plan-py/$DATA\_models/$IDENTIFIER
mkdir -p $OUTPUT

SUM_OUT=/mnt/cephfs2/nlp/hongmin.wang/table2text/data2text-plan-py/$DATA\_outputs/$IDENTIFIER
mkdir -p $SUM_OUT
