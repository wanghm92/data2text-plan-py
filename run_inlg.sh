...
OUTPUT=/mnt/cephfs2/nlp/hongmin.wang/table2text/nbagraph2summary/inlg_models/$IDENTIFIER
mkdir -p $OUTPUT

SUM_OUT=/mnt/cephfs2/nlp/hongmin.wang/table2text/nbagraph2summary/inlg_outputs/$IDENTIFIER
mkdir -p $SUM_OUT
