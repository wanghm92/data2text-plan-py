...
#            perl ~/onmt-tf-whm/third_party/multi-bleu.perl rotowire/$DATA/tgt_$DATA.txt < $BASE/gen/roto_stage2_$IDENTIFIER-oracle.$DATA.e$EPOCH.txt.tk
            ...
            python data_utils.py -mode prep_gen_data -gen_fi $BASE/gen/roto_stage2_$IDENTIFIER-beam5_gens.$DATA.e$EPOCH.txt.tk -dict_pfx downloads/ie_data/roto-ie -output_fi $BASE/transform_gen/roto_stage2_$IDENTIFIER-beam5_gens.$DATA.e$EPOCH.h5 -input_path ../boxscore-data/rotowire
            ...
            python data_utils.py -mode prep_gen_data -gen_fi $BASE/gen/roto_stage2_$IDENTIFIER-oracle.$DATA.e$EPOCH.txt.tk -dict_pfx downloads/ie_data/roto-ie -output_fi $BASE/transform_gen/roto_stage2_$IDENTIFIER-oracle.$DATA.e$EPOCH.h5 -input_path ../boxscore-data/rotowire
